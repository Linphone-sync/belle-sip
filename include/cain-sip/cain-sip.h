...
CAIN_SIP_DECLARE_TYPES_BEGIN(cain_sip,1)
	...
	CAIN_SIP_TYPE_ID(cain_sip_tunnel_listening_point_t),
	...
	CAIN_SIP_TYPE_ID(cain_sip_tunnel_channel_t),
	...
	CAIN_SIP_TYPE_ID(cain_sip_header_p_preferred_identity_t),
	CAIN_SIP_TYPE_ID(cain_sip_header_privacy_t)
