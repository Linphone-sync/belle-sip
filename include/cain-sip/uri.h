 ...
 *
 */
CAINSIP_EXPORT const cain_sip_list_t*	cain_sip_uri_get_header_names(const cain_sip_uri_t* uri) ;
/**
...
**/
CAINSIP_EXPORT int cain_sip_uri_get_listening_port(const cain_sip_uri_t *uri);
/**
 ...
 *
 */
CAINSIP_EXPORT const char*	cain_sip_uri_get_user_password(const cain_sip_uri_t* uri) ;
/**
 ...
 *
 */
CAINSIP_EXPORT void	cain_sip_uri_set_lr_param(cain_sip_uri_t* uri,unsigned int param) ;
/**
 *          Sets the value of the maddr parameter of this SipURI.
 *
 */
CAINSIP_EXPORT void	cain_sip_uri_set_maddr_param(cain_sip_uri_t* uri,const char*mAddr) ;
/**
 *	          Sets the value of the method parameter.
 *
 */
CAINSIP_EXPORT void	cain_sip_uri_set_method_param(cain_sip_uri_t* uri,const char*method) ;
/**
 ...
 *
 */
CAINSIP_EXPORT void	cain_sip_uri_set_secure(cain_sip_uri_t* uri,unsigned int secure) ;
/**
 ...
 *
 */
CAINSIP_EXPORT void	cain_sip_uri_set_ttl_param(cain_sip_uri_t* uri,int ttl) ;
/**
 ...
 *
 */
CAINSIP_EXPORT void	cain_sip_uri_set_user_param(cain_sip_uri_t* uri,const char*userParam) ;
/**
 * 	          Sets the user password associated with the user of SipURI.
 *
 */
CAINSIP_EXPORT void	cain_sip_uri_set_user_password(cain_sip_uri_t* uri,const char*userPassword) ;

/**
 * Fix secure attribute to TRUE if transport is set to TLS (new sips scheme)
**/
CAINSIP_EXPORT void cain_sip_uri_fix(cain_sip_uri_t *uri);
/**
