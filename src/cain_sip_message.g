...
media_type       
	:	 m_type {cain_sip_header_content_type_set_type($header_content_type::current,$m_type.text->chars);} 
	   slash 
	   m_subtype {cain_sip_header_content_type_set_subtype($header_content_type::current,$m_subtype.text->chars);} 
