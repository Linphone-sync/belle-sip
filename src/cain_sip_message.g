...
username          
	:	  username_token /*'username'*/ equal username_value {
																				char* unquoted_string = _cain_sip_str_dup_and_unquote_string($username_value.text->chars);
																				cain_sip_header_authorization_set_username($header_authorization::current,(const char*)unquoted_string);
																				cain_sip_free(unquoted_string);} ;
