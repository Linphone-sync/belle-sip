...
@init {$request::current = cain_sip_response_new(); $ret=$request::current; }         
	:	  status_line message_header[CAIN_SIP_MESSAGE($request::current)]+ last_crlf=CRLF {*($message_raw::message_length)=0;} /*message_body*/ ;
