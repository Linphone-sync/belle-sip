...
int cain_sip_auth_helper_fill_authorization(cain_sip_header_authorization_t* authorization
	...
	if (auth_mode) {
		...
		cain_sip_auth_helper_compute_response_qop_auth(ha1
														,cain_sip_header_authorization_get_nonce(authorization)
														,cain_sip_header_authorization_get_nonce_count(authorization)
		...
		cain_sip_auth_helper_compute_response(ha1,cain_sip_header_authorization_get_nonce(authorization),ha2,response);
	}
